...
public class Constants {
    ...
    public static final int kPronounColumn = 7;
    public static final int kRoleColumn = 8;
    public static final int kLastLoginColumn = 9;
    public static final int kLastLogoutColumn = 10;
    public static final int kHoursColumn = 11;
    public static final int kTotalHoursColumn = 12;
    public static final int kLoggedInColumn = 13;
