 ...
 * @author Dalton Smith
 * LoginNotifier
 * Checks if user account registration is complete,
 * this code is Grizzly Robotics specific
 */
public class LoginNotifier {
    public boolean checkNotifier(int studentIDRow, DatabaseUtils dbUtils) {
        String firstName = dbUtils.getCellData(studentIDRow, Constants.kFirstNameColumn, Constants.kMainSheet);
        String lastName = dbUtils.getCellData(studentIDRow, Constants.kLastNameColumn, Constants.kMainSheet);
